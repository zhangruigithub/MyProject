	...
	"""
		商品设置禁售地区或仅售地区，手机端购买
			...
			4.如：有商品已删除、已下架、已售罄、限制购买、库存不足、已经过期、已赠完和商品超出配送范围，不同商品并列提示
				同一个商品优先提示“超出范围”然后在提示-已删除、已下架、已售罄、限制购买、库存不足、已经过期、已赠完
	"""
...
@mall3 @eugene @product_limit_area
Scenario:2 购买多个商品地区不支持配送，提交订单错误提示(购买多个商品其中一个商品地区是禁售地区，不支持配送)
...
@mall3 @eugene @product_limit_area
Scenario:3 购买多个商品地区不支持配送，提交订单错误提示(购买多个商品其中多个商品地区是禁售地区，不支持配送)
	1.bill购买多个商品其中多个商品地区是禁售地区，不支持配送
...
@mall3 @eugene @product_limit_area
Scenario:4 购买多个商品地区不支持配送，提交订单错误提示(购买多个商品全部商品地区是禁售地区，不支持配送)
	1.bill购买多个商品全部商品地区是禁售地区，不支持配送
...
@mall3 @eugene @product_limit_area
Scenario:5 购买商品配置了禁售地区，后台修改限定区域模板(修改限定区域模板)
...
@mall3 @eugene @product_limit_area
Scenario:6 购买商品配置了禁售地区，后台修改限定区域模板(删除限定区域模板)
	1.bill购买商品配置了禁售地区,jobs删除限定区域模板后，bill成功下单
